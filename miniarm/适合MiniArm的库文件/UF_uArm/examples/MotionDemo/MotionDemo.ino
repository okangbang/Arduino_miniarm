...
void setup() 
{
  EEPROM.write(0, 0xEE); 
  EEPROM.write(1, 0); 
  EEPROM.write(2, 0);  //3个标志位，表示arm已经经过调整。
...
void motionReturn()
{
  uarm.setPosition(90, 0, 25, 0);    // stretch out
  delay(400);
  uarm.setPosition(90, -45, 25, 0);  // down
  uarm.gripperCatch();                // catch
  delay(400);
  uarm.setPosition(90, 0, 25, 0);    // up
  delay(400);
  uarm.setPosition(90, 0, 0, 0);     // rotate
  delay(400);
  uarm.setPosition(90, -45, 0, 0);   // down
  delay(400);
  uarm.gripperRelease();              // release
  delay(100);
  uarm.setPosition(90, 0, 0, 0);     // up
  delay(400);
  uarm.setPosition(60, 0, 0, 0);       // original position
  delay(400);
  uarm.gripperDirectDetach();         // direct detach 
  delay(500);
}
